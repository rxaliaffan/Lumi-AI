    ...
    <main className="flex min-h-screen bg-[#f6f7fb]">
      ...
      <aside className="w-[270px] bg-white border-r p-5 flex flex-col">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white text-xl">
            ✨
          </div>
          <div>
        ...
        {/* BOT CARD */}
        <div className="mt-auto bg-gradient-to-br from-indigo-100 to-purple-100 p-4 rounded-2xl text-center">
        ...
        <div className="grid grid-cols-[1fr_330px] gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              <Action label="Order Medicine" color="from-purple-500 to-indigo-500" />
              <Action label="Consult Doctor" color="from-blue-500 to-indigo-500" />
              <Action label="Set Reminder" color="from-green-500 to-emerald-500" />
              <Action label="Share Report" color="from-purple-400 to-pink-400" />
            </div>
          ...
          <div className="space-y-6">
            ...
            <Card title="Today's Schedule">
              <Schedule time="8:00 AM" name="Metformin" status="Taken" />
              <Schedule time="1:00 PM" name="Amoxicillin" status="Due" />
              <Schedule time="8:00 PM" name="Aspirin" status="Due" />
            </Card>
...
function Schedule({ time, name, status }) {
  return (
    <div className="flex justify-between py-2 text-[14px]">
      <span>{time}</span>
      <span>{name}</span>
      <span className={status === "Taken" ? "text-green-500" : "text-indigo-500"}>
        {status}
      </span>
    </div>
  );
...
function Warn({ title, color }) {
  return (
    <div className={`p-3 rounded-xl border text-${color}-500 bg-${color}-50`}>
...
function Action({ label, color }) {
  return (
    <div className={`p-4 rounded-xl text-white text-center bg-gradient-to-r ${color}`}>
      {label}
    </div>
  );
}
